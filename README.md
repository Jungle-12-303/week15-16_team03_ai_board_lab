...
실제 사용자 기준 월 비용은 전체 가입자 수보다 `DAU * AI 버튼 사용 횟수`에 의해 결정된다. 예를 들어 DAU 50명 교육반/스터디 시나리오에서 Related 5회, Draft 2회, Agent 1회를 매일 사용한다고 가정하면 월 OpenAI 비용은 대략 `$6.20 ~ $17.16` 수준으로 추정했다.
...
APP_AI_RATE_LIMIT_MAX_REQUESTS=20
APP_AI_RATE_LIMIT_WINDOW_SECONDS=60
