...
- JWT token은 어떤 요청의 `Authorization` header에 들어가는가
...
| 파일 | 역할 |
| --- | --- |
| `frontend/project-alpha/src/hooks/useAuth.js` | 로그인 성공 후 token 저장 |
| `frontend/project-alpha/src/storage/authStorage.js` | localStorage 저장/복원 |
